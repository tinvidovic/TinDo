    ...
    private fun setRadioButtonListeners() {
        ...
        binding.createEditTodoLayout.radioGroupColors.setOnCheckedChangeListener { _, checkedId ->
            ...
            when (checkedId) {
                ...
                binding.createEditTodoLayout.radioYellow.id -> viewModel.onTodoColorChanged(ToDoColor.YELLOW)
                ...
                binding.createEditTodoLayout.radioOrange.id -> viewModel.onTodoColorChanged(ToDoColor.ORANGE)
